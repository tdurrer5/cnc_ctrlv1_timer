...
#define Serial.println(x)   printf(x)

#define sq(x)  x * x

//#define String char[]   //tdu
...
float constain(float,unsigned int,unsigned int);

unsigned long millis(void); //tdu
...
void analogWrite(int , byte);
void digitalWrite(byte,byte);   //digitalWrite(_pwmPin, HIGH);
